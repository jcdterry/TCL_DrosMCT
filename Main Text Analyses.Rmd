...
CombinedPlot<- grid.arrange(Fig2_Explainer + ggtitle( 'a) Guide to coexistence plane'),
             focal_Safe + ggtitle( '        b) Example Pair:\n              D. sulfurigaster and D. birchii',
...
**Table SXXXXX**: Assessment of reproductive rate – susceptibility relationships as a heuristic for the impact of parasitism on pairwise coexistence. 7/15 were in the ‘correct’ direction, strongly suggesting that such tradeoffs are not useful shortcuts ion practice, once the impact of competitive coefficients are taken into account. [MOVE TO A MAIN SI ]
